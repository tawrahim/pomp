...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[[AppDelegate instance].colorSwitcher getImageWithName:@"background.png"]];
    ...
    */
    ...
    [colorButton setBackgroundImage:[[AppDelegate instance].colorSwitcher getImageWithName:@"button-green.png"] forState:UIControlStateNormal];
    
        
    [colorButtonSelected setBackgroundImage:[[AppDelegate instance].colorSwitcher getImageWithName:@"button-green-pressed.png"] forState:UIControlStateNormal];
