...
{
    [[AppDelegate instance].colorSwitcher configureAppWithHue:hueSlider.value andSaturation:saturationSlider.value];
    
    [[AppDelegate instance] customizeGlobalTheme];
    
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) 
    {
        [[AppDelegate instance] customizeiPadTheme];
